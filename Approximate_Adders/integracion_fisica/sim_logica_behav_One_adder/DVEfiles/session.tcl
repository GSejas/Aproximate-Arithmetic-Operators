...
# DVE full session
# Saved on Sun Nov 20 15:32:07 2016
# Designs open: 1
...
# 	TopLevel.1
#   Source.1: ACA_II_N16_Q8
#   Wave.1: 33 signals
#   Group count = 2
#   Group Testbench_Adder signal count = 17
...
gui_set_env SIMSETUP::SIMARGS {{ +v2k +lint=all -a log_name +define+SINGLE +define+ACAIIN16Q4 +neg_tchk -ucligui}}
...
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+SINGLE +define+ACAIIN16Q4 +neg_tchk -ucligui} -dir /mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/Approximate_Adders/integracion_fisica/sim_logica_behav_mult -nosource
}
}
...
gui_load_child_values {Testbench_Adder.inst_Approx_adder}
...
append _session_group_2 inst_Approx_adder
gui_sg_create "$_session_group_2"
set Testbench_Adder|inst_Approx_adder "$_session_group_2"

gui_sg_addsignal -group "$_session_group_2" { Testbench_Adder.inst_Approx_adder.temp_upper_addition Testbench_Adder.inst_Approx_adder.in1 Testbench_Adder.inst_Approx_adder.in2 Testbench_Adder.inst_Approx_adder.lower_res Testbench_Adder.inst_Approx_adder.add_sub Testbench_Adder.inst_Approx_adder.lower_in2_signed Testbench_Adder.inst_Approx_adder.approx_cout Testbench_Adder.inst_Approx_adder.BIGGER16.LowL Testbench_Adder.inst_Approx_adder.upper_in2_signed Testbench_Adder.inst_Approx_adder.in2_signed Testbench_Adder.inst_Approx_adder.W Testbench_Adder.inst_Approx_adder.lower_in1 Testbench_Adder.inst_Approx_adder.lower_in2 Testbench_Adder.inst_Approx_adder.upper_in1 Testbench_Adder.inst_Approx_adder.upper_in2 Testbench_Adder.inst_Approx_adder.res Testbench_Adder.inst_Approx_adder.LowL }
gui_set_radix -radix {decimal} -signals {Sim:Testbench_Adder.inst_Approx_adder.BIGGER16.LowL}
gui_set_radix -radix {twosComplement} -signals {Sim:Testbench_Adder.inst_Approx_adder.BIGGER16.LowL}
...
# Restore C1 time
gui_set_time -C1_only 2000100000
...
gui_wv_zoom_timerange -id ${Wave.1} 2000099875 2000100125
...
gui_list_select -id ${Wave.1} {Testbench_Adder.inst_Approx_adder.lower_in2 }
...
gui_marker_move -id ${Wave.1} {C1} 2000100000
...
gui_open_source -id ${Source.1}  -replace -active ACA_II_N16_Q8 /mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/Approximate_Adders/integracion_fisica/sim_logica_behav_mult/../front_end/source/ACA_II_N16_Q8.v
