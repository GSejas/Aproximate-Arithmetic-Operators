...
# DVE full session
# Saved on Sun Nov 20 19:26:10 2016
# Designs open: 1
...
gui_set_env SIMSETUP::SIMARGS {{+v2k +lint=all -a log_name +define+ACAIN8Q5 +neg_tchk +sdfverbose}}
...
gui_sim_run Ucli -exe simv -args { +v2k +lint=all -a log_name +define+ACAIN8Q5 +neg_tchk +sdfverbose -ucligui} -dir /mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/Approximate_Adders/integracion_fisica/simu_logica_behav_multiplier -nosource
}
}
...
catch {gui_list_select -id ${Hier.1} {ACA_II_N16_Q4}}
gui_view_scroll -id ${Hier.1} -vertical -set 323
gui_view_scroll -id ${Hier.1} -horizontal -set 0

# Data 'Data.1'
gui_list_set_filter -id ${Data.1} -list { {Buffer 1} {Input 1} {Others 1} {Linkage 1} {Output 1} {LowPower 1} {Parameter 1} {All 1} {Aggregate 1} {LibBaseMember 1} {Event 1} {Assertion 1} {Constant 1} {Interface 1} {BaseMembers 1} {Signal 1} {$unit 1} {Inout 1} {Variable 1} }
gui_list_set_filter -id ${Data.1} -text {*}
gui_list_show_data -id ${Data.1} {ACA_II_N16_Q4}
...
gui_open_source -id ${Source.1}  -replace -active ACA_II_N16_Q4 /mnt/vol_NFS_Zener/WD_ESPEC/jsequeira/Documents/Dise-o-ASIC-FPGA-FPU/ASIC_FLOW/Approximate_Adders/integracion_fisica/simu_logica_behav_multiplier/../front_end/source/ACA_II_N16_Q4.v
